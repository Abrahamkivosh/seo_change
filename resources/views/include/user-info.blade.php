            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <p class="text-default">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                            <blockquote>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="mypost">
                                    ...
                                    <div class="mypost-list m-t-30">
                                        <div class="post-box">
                                            ...
                                            <p>If you are going to  a passage of Lorem Ipsum, you need to be sure there isnt anything embarrassing hidden in the middle of text</p>
                                            <div class="form-group">
                                        ...
                                        <div class="post-box">
                                            ...
                                            <p>Printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, </p>
                                            <div class="form-group">
                                                <a href="javascript:void(0);" class="btn btn-raised btn-info"><i class="zmdi zmdi-favorite-outline"></i> Like (5) </a>
                                                <a href="javascript:void(0);" class="btn btn-raised btn-default"><i class="zmdi zmdi-long-arrow-return"></i> Reply</a>
                                            </div>
