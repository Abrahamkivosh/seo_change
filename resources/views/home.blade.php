        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Number of your project</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Projects Admins</span>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Your detials</h3>
                  ...
                  <!-- /.card-header -->
                  <div class="card-body p-0 bg bg-light-blue">
          ...
          <div class="col-md-4">
            ...
            <div class="info-box mb-3 bg-warning">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ALL YOUR PROJECT</span>
            ...
            <div class="info-box mb-3 bg-danger">
              ...
              <div class="info-box-content">
                <span class="info-box-text">PEDDING PROJECT</span>
            ...
            <div class="card">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="https://tbxhost.co.uk/cloud-web-hosting-kenya" class="product-title">cloud-web-hosting-kenya
                        <span class="badge badge-success float-right">$3.00</span></a>
              ...
              <!-- /.card-body -->
              <div class="card-footer text-center">
                <a href="http://seokenya.co.ke" class="uppercase">View All Products</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
