...
@section('content')
     ...
     <div class="row col-md-9 col-lg-9 col-sm-9 pull-left ">
      ...
      <div class="well well-lg" >
        <h1>PROJECT NAME :</h1><h1 class=" text-bold text-uppercase text-info"> {{ $project->name }}</h1>
       ...
       <!-- <p>
           <a class="btn btn-lg btn-success" href=" route('downloadproject',$project->id) " role="button">
               Get started today
            </a></p> -->
      </div>
...
<div class="col-sm-3 col-md-3 col-lg-3 pull-right">
          ...
          <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
              ...
              <li><a href="/projects"><i class="fa fa-user-o" aria-hidden="true"></i>Clients projects</a></li>
            ...
            <br/>
              ...
              <!-- <li><a href="#">Add Adminstrator to work on project</a></li> -->
            </ol>
<hr/>

            <h4>Add Adminstrator to work on project</h4>
            <div class="row">
...
<br/>
            <h4 class=" text-justify text-warning">Adminstrators working on project</h4>
